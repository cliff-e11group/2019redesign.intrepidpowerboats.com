                ...
                foreach ($facebook_reviews as $facebook_review) {
                    ...
                    $review = json_decode(json_encode(
                        array(
                            ...
                            'text'          => isset($facebook_review->review_text) ? wp_encode_emoji($facebook_review->review_text) : '',
                            'author_avatar' => isset($facebook_review->reviewer->picture) ? $facebook_review->reviewer->picture->data->url : BRB_FACEBOOK_AVATAR,
