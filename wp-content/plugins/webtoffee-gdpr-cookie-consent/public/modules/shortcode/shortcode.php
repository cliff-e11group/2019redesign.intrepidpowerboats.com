...
class Cookie_Law_Info_Shortcode {
    ...
    */
    public function cookielawinfo_shortcode_accept_button( $atts ) 
    {
        ...
        return '<a  class="wt-cli-element cli_action_button cli-accept-button medium cli-plugin-button ' . $colour . '" data-cli_action="accept" >' . stripslashes( $settings['button_1_text'] ) . '</a>';
    }
