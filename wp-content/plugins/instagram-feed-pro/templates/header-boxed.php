...
$bio               = SB_Instagram_Parse_Pro::get_bio( $header_data );
...
?>
<div class="sb_instagram_header sbi_header_style_boxed <?php echo esc_attr( $type_class ); ?><?php echo esc_attr( $size_class ); ?>" <?php echo $header_style; ?>
    <?php echo $story_data_att; ?>>
<a href="<?php echo esc_url( 'https://www.instagram.com/' . $username ); ?>" target="_blank" rel="noopener"
   ...
   class="sbi_header_link">
    ...
    <div class="sbi_header_bar" <?php echo $header_bar_style; ?>>
        ...
        <a class="sbi_header_follow_btn<?php echo esc_attr( $follow_btn_classes ); ?>" href="<?php echo esc_url( 'https://www.instagram.com/' . $username ); ?>" target="_blank" rel="noopener" <?php echo $follow_btn_style; ?>>
