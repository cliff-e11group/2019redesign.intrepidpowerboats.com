...
<main class="main">
    <section class="primary-block primary-block--dark">
        <div class="container">
            ...
            <div class="primary-block__sticky-box">
                <p>You can’t wait for iinnovation, <strong>you have to go after it.</strong></p>
            </div>
        </div>
    </section>
    ...
    <section class="media-content media-content--dark">
        <div class="container">
            <div class="media-content__item media-content__item--sticky-image">
                ...
                <div class="media-content__details">
                    <h2 class="media-content__title">An exceptional ride.</h2>
                    <div class="media-content__description">
                        <p>Thanks to the distinct stepped hull design the CG (center of gravity) is positioned perfectly, producing an extraordinarily well-balanced ride. The boat takes off level and actually feels like you’re levitating onto plane. Waves are flattened, at any angle, with very little jolt transmitted. This makes for a smooth, dry ride, no lag and a noise factor that, to be honest, is really not a factor at all. The ride is quiet, allowing for normal conversation with an extra measure of comfort and pleasure for all aboard.</p>
                    </div>
                </div>
            </div>
            <div class="media-content__item media-content__item--sticky-image">
