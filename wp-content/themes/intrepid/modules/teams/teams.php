 ...
 */
function e11_teams($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'featured_team_title' => $get_field_type($prefix . 'featured_team_title', $field_location),
            'featured_team' => $get_field_type($prefix . 'featured_team_members', $field_location),
            'team' => $get_field_type($prefix . 'team', $field_location),
        );
    else:
        $defaults = array(
            'featured_team' => array(),
