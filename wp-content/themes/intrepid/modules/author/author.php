 ...
 */
function e11_author($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'name' => $get_field_type($prefix . 'author_name', $field_location),
            'image' => $get_field_type($prefix . 'author_image', $field_location),
