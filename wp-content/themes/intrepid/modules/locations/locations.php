 ...
 */
function e11_locations($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'locations' => $get_field_type($prefix . 'locations', $field_location),
