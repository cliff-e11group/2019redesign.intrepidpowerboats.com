...
function e11_hero_video($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            ...
            'placeholder_video' => $get_field_type($prefix . 'hero_placeholder_video_url', $field_location),
            'placeholder_image' => $get_field_type($prefix . 'hero_video_placeholder_image', $field_location),
