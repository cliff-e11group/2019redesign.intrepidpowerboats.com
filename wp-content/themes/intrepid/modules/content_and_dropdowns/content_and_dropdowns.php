 ...
 */
function e11_content_and_dropdowns($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'content' => $get_field_type($prefix . 'content_and_dropdowns', $field_location),
