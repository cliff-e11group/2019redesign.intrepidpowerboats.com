 ...
 */
function e11_page_details($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'title' => $get_field_type($prefix . 'page_title', $field_location),
            'tagline' => $get_field_type($prefix . 'page_tagline', $field_location),
    ...
    if (!empty($data)):
        include 'tpl/page_details.tpl.php';
    endif;
