 ...
 */
function e11_hero_image_columns($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'column_1' => $get_field_type($prefix . 'hero_image_column_1', $field_location),
            'column_2' => $get_field_type($prefix . 'hero_image_column_2', $field_location),
            'intro_text' => $get_field_type($prefix . 'hero_image_intro_text', $field_location),
    ...
    if (!empty($data)):
        include 'tpl/hero_image_columns.tpl.php';
    endif;
