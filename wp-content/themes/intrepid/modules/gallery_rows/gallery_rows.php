 ...
 */
function e11_gallery_rows($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'gallery_rows' => $get_field_type($prefix . 'gallery_rows', $field_location),
    ...
    if (!empty($data['gallery_rows'])):
        include 'tpl/gallery_rows.tpl.php';
    endif;
