 ...
 */
function e11_locations_and_customer_service($args = array(), $use_page_content = false, $get_field_type = 'get_field', $field_location = '', $prefix = false)
{
    ...
    if ($use_page_content):
        $defaults = array(
            'locations' => $get_field_type($prefix . 'locations_and_contacts', $field_location),
    ...
    if (!empty($data['locations'])):
        include 'tpl/locations_and_customer_service.tpl.php';
    endif;
