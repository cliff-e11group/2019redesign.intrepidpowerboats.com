        ...
        <div class="container">
            <div class="sidebar layout__one-third">
                <div class="instagram-block">
                    ...
                    <?php echo do_shortcode('[instagram-feed type=user layout=carousel imagepadding=0 num=5 nummobile=5 cols=1 colsmobile=1 carouselrows=1 carouselautoplay=true carouseltime=3000 lightboxcomments=true showcaption=false showlikes=false showfollow=false width=100 widthunit=% autoscroll=true]'); ?>
                    <?php
